...
public class DishDAO extends BaseDAO implements DishSystem {
    ...
    private String urlHead="http://124.71.236.232:8888/down/iyCulXppgeF9?fname=/";
    @Override
    ...
    @Override
    public BufferedImage readImage(Dish dish) {
        String dishPath=".\\image\\"+dish.getdId()+".jpg";
        BufferedImage image = null;
        try {
            image = ImageIO.read(new File(dishPath));
        } catch (IOException e) {
            e.printStackTrace();
        }finally {
    ...
    public static void main(String[] args) {
        ...
        BufferedImage i= d.readImage(d.DishReadin("01001"));
